defmodule TradingIndicators.Trend.HMATest do
        ...
        data ++
          [
            %{
              ...
              timestamp: DateTime.add(~U[2024-01-01 09:30:00Z], 26, :minute)
            },
            %{
              close: Decimal.new("125"),
              timestamp: DateTime.add(~U[2024-01-01 09:30:00Z], 27, :minute)
            }
          ]
  ...
  describe "validate_params/1" do
    ...
    test "rejects invalid period" do
      # Too small
      assert {:error, %Errors.InvalidParams{}} = HMA.validate_params(period: 1)
  ...
  describe "streaming functionality" do
    test "init_state/1 creates proper initial state" do
      ...
      # div(9, 2) = 4
      assert state.half_period == 4
      # sqrt(9) = 3
      assert state.sqrt_period == 3
