defmodule TradingIndicators.Volatility.StandardDeviationTest do
  ...
  describe "calculate/2" do
    ...
    test "calculates with population standard deviation" do
      {:ok, sample_results} = StandardDeviation.calculate(@sample_price_series, period: 3, calculation: :sample)
      {:ok, pop_results} = StandardDeviation.calculate(@sample_price_series, period: 3, calculation: :population)
    ...
    test "calculates with different price sources" do
      {:ok, close_results} = StandardDeviation.calculate(@sample_ohlcv_data, period: 3, source: :close)
      {:ok, high_results} = StandardDeviation.calculate(@sample_ohlcv_data, period: 3, source: :high)
    ...
    test "returns error for invalid calculation type" do
      {:error, error} = StandardDeviation.calculate(@sample_ohlcv_data, period: 3, calculation: :invalid)
  ...
  describe "edge cases" do
    ...
    test "handles large datasets efficiently" do
      ...
      assert length(results) == 951  # 1000 - 50 + 1
  ...
  describe "mathematical accuracy" do
    test "matches known standard deviation calculation" do
      ...
      simple_data = [
        Decimal.new("2.0"), Decimal.new("4.0"), Decimal.new("4.0"), 
        Decimal.new("4.0"), Decimal.new("5.0"), Decimal.new("5.0"), 
        Decimal.new("7.0"), Decimal.new("9.0")
      ]
