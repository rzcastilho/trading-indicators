defmodule TradingIndicators.Momentum.StochasticTest do
  ...
  describe "calculate/2" do
    ...
    test "calculates Stochastic with custom parameters" do
      ...
      {:ok, results} = Stochastic.calculate(data, k_period: 10, d_period: 2, k_smoothing: 3, overbought: 85, oversold: 15)
    ...
    test "returns error for invalid data format" do
      invalid_data = [
        %{close: Decimal.new("100"), timestamp: ~U[2024-01-01 09:30:00Z]}  # Missing high and low
      ]
  ...
  describe "streaming functionality" do
    ...
    test "update_state/2 processes data points correctly" do
      ...
      data_points = [
        ...
        %{high: Decimal.new("109"), low: Decimal.new("99"), close: Decimal.new("104"), timestamp: ~U[2024-01-01 09:34:00Z]}
      ]
      ...
      assert is_map(final_result)  # Should have a result with k_period=3, d_period=2 after 4 points
    ...
    test "update_state/2 returns error for invalid data" do
      ...
      invalid_data = %{close: Decimal.new("100")}  # Missing high and low
  ...
  describe "required_periods/0" do
    test "returns default required periods" do
      assert Stochastic.required_periods() == 16  # k_period(14) + d_period(3) - 1
    end
  end
  ...
  describe "validate_params/1" do
    test "validates valid parameters" do
      assert :ok == Stochastic.validate_params(k_period: 14, d_period: 3, overbought: 80, oversold: 20)
    end
  ...
  describe "mathematical accuracy" do
    test "calculates correct %K value" do
      ...
      data = [
        %{high: Decimal.new("110"), low: Decimal.new("90"), close: Decimal.new("100"), timestamp: ~U[2024-01-01 09:30:00Z]},
        %{high: Decimal.new("115"), low: Decimal.new("95"), close: Decimal.new("105"), timestamp: ~U[2024-01-01 09:31:00Z]},
        %{high: Decimal.new("112"), low: Decimal.new("92"), close: Decimal.new("102"), timestamp: ~U[2024-01-01 09:32:00Z]}
      ]
    ...
    test "handles edge cases" do
      ...
      data = [
        %{high: Decimal.new("100"), low: Decimal.new("100"), close: Decimal.new("100"), timestamp: ~U[2024-01-01 09:30:00Z]},
        %{high: Decimal.new("100"), low: Decimal.new("100"), close: Decimal.new("100"), timestamp: ~U[2024-01-01 09:31:00Z]},
        %{high: Decimal.new("100"), low: Decimal.new("100"), close: Decimal.new("100"), timestamp: ~U[2024-01-01 09:32:00Z]}
      ]
