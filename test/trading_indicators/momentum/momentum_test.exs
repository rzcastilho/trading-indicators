defmodule TradingIndicators.Momentum.MomentumTest do
  use ExUnit.Case
  alias TradingIndicators.Momentum.Momentum
  require Decimal
  doctest Momentum
  ...
  describe "calculate/2" do
    test "calculates Momentum with sufficient data" do
      ...
      assert metadata.normalized == false
  ...
  describe "streaming functionality" do
    test "init_state/1 initializes proper state" do
      ...
      assert state.normalized == true
      assert state.previous_prices == []
      assert state.momentum_values == []
  ...
  describe "mathematical accuracy" do
    test "calculates correct raw momentum" do
      # Simple test case: price goes from 100 to 110, momentum = 10
      data_points = [
        %{close: Decimal.new("100"), timestamp: ~U[2024-01-01 09:30:00Z]},
        %{close: Decimal.new("102"), timestamp: ~U[2024-01-01 09:31:00Z]},
    ...
    test "calculates correct normalized momentum" do
      # Simple test case: price goes from 100 to 110, normalized momentum = 0.10
      data_points = [
        %{close: Decimal.new("100"), timestamp: ~U[2024-01-01 09:30:00Z]},
        %{close: Decimal.new("102"), timestamp: ~U[2024-01-01 09:31:00Z]},
        %{close: Decimal.new("110"), timestamp: ~U[2024-01-01 09:32:00Z]}
    ...
    test "handles zero division in normalized momentum" do
    ...
    test "calculates smoothed momentum correctly" do
      # Test smoothing with simple values
      data_points = [
        %{close: Decimal.new("100"), timestamp: ~U[2024-01-01 09:30:00Z]},
        %{close: Decimal.new("102"), timestamp: ~U[2024-01-01 09:31:00Z]},
