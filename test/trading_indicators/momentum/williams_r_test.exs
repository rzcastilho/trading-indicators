defmodule TradingIndicators.Momentum.WilliamsRTest do
  ...
  describe "mathematical accuracy" do
    test "calculates correct Williams %R value" do
      ...
      data = [
        %{high: Decimal.new("110"), low: Decimal.new("90"), close: Decimal.new("95"), timestamp: ~U[2024-01-01 09:30:00Z]},
        %{high: Decimal.new("115"), low: Decimal.new("85"), close: Decimal.new("90"), timestamp: ~U[2024-01-01 09:31:00Z]},
        %{high: Decimal.new("112"), low: Decimal.new("88"), close: Decimal.new("92"), timestamp: ~U[2024-01-01 09:32:00Z]}
      ]
